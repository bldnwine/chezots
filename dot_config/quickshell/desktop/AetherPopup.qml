    ...
    Column {
        ...
        Item {
            ...
            DisplayChip {
                ...
                label: "OPEN GUI"
                onActivated: {
                    aetherPopup.root.run(aetherPopup.root.aetherBin || "aether");
                }
            }
            DisplayChip {
                root: aetherPopup.root
                ...
                label: "RANDOM REGEN"
                onActivated: {
                    aetherPopup.root.run("sh -c '"
                        + aetherPopup.root.aetherBin + " --generate \"$(" + aetherPopup.root.aetherBin + " --random-wallpaper)\""
                        + " && " + aetherPopup.root.pushThemeScript + "'");
                }
            }
        }
    }
